                        ...
                        using (OCPPCoreContext dbContext = new OCPPCoreContext(Configuration))
                        {
                            ...
                            if (transaction != null)
                            {
                                if (transaction.ConnectorId > 0)
                                {
                                    ...
                                    UpdateConnectorStatus(transaction.ConnectorId, ConnectorStatusEnum.Available.ToString(), null, (double)stopTransactionRequest.MeterStop / 1000, stopTransactionRequest.Timestamp);
                                }
